...
Cabin is a room. Description is "An old, abandoned cabin sits solemnly against the trees.  North of Cabin is Attic. East of Cabin is Bedroom. South is Forest Clearing."
...
Wooden Key is a thing. It is in Eastern Field. It is undescribed. Description is "A wooden key that came from the tree stump. How conveniant." 
...
Instead of giving canteen to Luigi: say "Luigi: Yo thanks! Here's the book, as promised.";
	move ouija book to player;
	say "[paragraph break] You are now carrying the Ouija Book."
...
The cabin door is north of the forest clearing. Cabin door is south of the cabin. The cabin door is a door. The cabin door is scenery.
The cabin door is lockable and unlocked. The wooden key unlocks the cabin door.
...
ouija book is a thing. Description is "An odd, worn book. The cover reads: Beware of Ouija Boards. There seem to be five pages in the book, though many of the words are smudged and indecipherable."
...
Check talking to: say "Luigi: Yo! Feel free to ask me about stuff. [paragraph break] You can ask Luigi about Tent, Himself, Yourself, Book, etc."

Instead of asking Luigi about "Ouija Boards": say "Luigi: They're so cool!!!!!!"

Instead of asking Luigi about "Patch of Dirt": say "Luigi: Maybe if you had some sort of tool to investigate..."

Instead of asking Luigi about "Cabin": say "Luigi: Some creepy old cabin. I wonder who used to live there. There has to be some way to unlock the door."

Instead of asking Luigi about "Book": say "Luigi: This? It's my book on Ouija Boards. Maybe I'll let you read it if you can get me some water, I'm getting kind of thirsty."
...
Instead of asking Luigi about "Campsite": say "Luigi: They say this whole area is haunted, and that there might even be buried treasure!"
